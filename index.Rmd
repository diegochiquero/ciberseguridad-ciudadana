...
ontsize: 11pt
fontfamily: bookman
github-repo: diegochiquero/ciberseguridad-ciudadana
description: "Guía de lectura recomendado para conecer los ciberdelitos a los que nos exponemos y cómo evitarlos en un entorno cada vez más dominado por la Inteligencia artificial."
keywords: "seguridad, privacidad, ciberdelitos, ciberdelincuentes, ciberseguridad ciudadana, internet, inteligencia artificial"
...
Esta guía está disponible en el repositorio Github: [diegochiquero/ciberseguridad-ciudadana](https://github.com/diegochiquero/ciberseguridad-ciudadana). Y ha sido escrito en [R-Markdown](http://rmarkdown.rstudio.com) empleando el paquete [`bookdown`](https://bookdown.org/) cuya guia encontrarás en [@R-bookdown].
